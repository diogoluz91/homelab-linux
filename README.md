...
•	Learn Linux TV (YouTube) — Linux e administração de sistemas em profundidade
•	Curso oficial Terraform — developer.hashicorp.com/terraform/tutorials
•	Kodekloud (pago, mas excelente) — Labs interactivos de Kubernetes, Docker e DevOps
